...
The traditional regional approach measures technological complexity as a relative index reflecting regional technological capabilities, shaped by the economic advantages arising when corporations cluster within particular countries or cities, known as agglomeration economies \cite{hartmann2024economic}. Consequently, this method inherently captures spatial inequalities and is strongly influenced by urbanization levels in Japan. When evaluating a region’s technological portfolio, this approach typically provides limited insights, either indicating binary specialization in technologies (0 or 1) or offering only the average TCI of the specialized technologies. Furthermore, finer classifications, such as IPC classes, tend to produce less consistent complexity indices compared to broader classifications like the Schmoch system \cite{PintarEssletzbichler2022}.
...
% However, evaluations derived from this approach vary significantly depending on how regions or technologies are aggregated \cite{Hidalgo2021}.
% However, finer classifications, such as IPC classes, tend to produce less consistent complexity indices compared to broader classifications like the Schmoch system \cite{PintarEssletzbichler2022}. 
% Specifically, finer classifications, such as IPC classes, tend to produce less consistent complexity indices compared to broader classifications like the Schmoch system \cite{PintarEssletzbichler2022}. 
% Such inconsistencies appear in both regional and technological complexity evaluations due to the symmetric nature of the bipartite network structure underlying these calculations.
