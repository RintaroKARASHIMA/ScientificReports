...
Additionally, filtering criteria are essential to exclude extreme cases capable of distorting analytical outcomes \cite{Hidalgo2021,PintarScherngell2022}. Accordingly, a filtering criterion based on patent distribution per corporation  is applied in this study, retaining only the top 3\% of corporations in patent output (Fig. ef{fig\:patentdistribution}). This filtering criterion excludes corporations exhibiting minimal patenting activity, thereby reducing significant analytical noise in network analyses. Following this filtering, the dataset comprises 2,485,027 patents filed by 1,938 corporations, representing approximately 93\% of the original patent volume.
