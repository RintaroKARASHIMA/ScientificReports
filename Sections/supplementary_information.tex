...
\begin{figure}[ht]
    \centering
    \includegraphics[scale=1.50]{Figs/FigA2.eps}
    \caption{
      (A) Changes in the five-year rolling ranking of the TCI based on 124 three-digit IPC classes for the corporate analysis.
      (B) Changes in the five-year rolling ranking of the TCI based on 124 three-digit IPC classes for the regional analysis.
    }
    \label{fig:bump}
\end{figure}
